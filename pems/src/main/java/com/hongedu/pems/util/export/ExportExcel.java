...
public class ExportExcel {
	 private HSSFWorkbook wb = null;  
	     ...
	     *            该报表的列数  
	     */ 
	    public void createNormalHead(String headString,int rolNum, int colSum) {  
	        ...
	        // 指定合并区域  
	        sheet.addMergedRegion(new Region(rolNum, (short) 0, rolNum, (short) colSum));  
	     ...
	     * @param colSum
	     */
	    public void createCtaegory(String headString,int rolNum, int colSum) {  
	     ...
	     *            需要合并到的列索引  
	     */ 
	    public void createNormalTwoRow(String[] params, int colSum ,int param) {  
	        HSSFRow row1 = sheet.createRow(param);  
	        row1.setHeight((short) 300);  
	 
	        HSSFCell cell2 = row1.createCell(0);  
	 
	        cell2.setCellType(HSSFCell.ENCODING_UTF_16);  
	        cell2.setCellValue(new HSSFRichTextString("姓名：" + params[0] + "		部门："+params[1]+"		岗位："+params[2]+"		直属上级："+params[3]+"			考核开始时间："+params[4]+"		考核截止时间："+params[5]));   
	        ...
	        // 指定合并区域  
	        //sheet.addMergedRegion(new Region(1, (short) 0, 1, (short) colSum));  
	       // sheet.addMergedRegion(new Region(2, (short) 0, 4, (short) 4)); 
	        HSSFCellStyle cellStyle = wb.createCellStyle();  
	        cellStyle.setAlignment(HSSFCellStyle.ALIGN_CENTER); // 指定单元格居中对齐  
	        cellStyle.setVerticalAlignment(HSSFCellStyle.VERTICAL_CENTER);// 指定单元格垂直居中对齐  
	        cellStyle.setWrapText(true);// 指定单元格自动换行  
